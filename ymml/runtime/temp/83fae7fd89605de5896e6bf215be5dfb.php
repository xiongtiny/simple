<?php /*a:4:{s:67:"D:\working\Test\ymml\application\admin\view\v1\user\addspecial.html";i:1529549528;s:62:"D:\working\Test\ymml\application\admin\view\v1\Inc\header.html";i:1529549528;s:60:"D:\working\Test\ymml\application\admin\view\v1\Inc\main.html";i:1529549528;s:59:"D:\working\Test\ymml\application\admin\view\v1\Inc\nav.html";i:1529549528;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		<meta charset="utf-8" />
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="/admin/v1/user/specialSave?id=<?php echo htmlentities($id); ?>" method="post">

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="subject">商品名称： </label>
                                <div class="col-sm-9">
                                    <select class="form-control" id="" name="goods_id" style="width: 150px;">
                                        <?php foreach($goods as $good): ?>
                                        <option value="<?php echo htmlentities($good->id); ?>"><?php echo htmlentities($good->name); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >特价(元)：</label>

                                <div class="col-sm-9">
                                    <input type="text"  name="price" placeholder="请输入特殊价格" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
