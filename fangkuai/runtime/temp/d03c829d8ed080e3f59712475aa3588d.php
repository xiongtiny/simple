<?php /*a:2:{s:64:"D:\phpStudy\WWW\fangkuai\application\admin\view\index\users.html";i:1525943057;s:64:"D:\phpStudy\WWW\fangkuai\application\admin\view\public\head.html";i:1526435399;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="widget-body  am-fr">
                                ...
                                <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                                    <div class="am-form-group tpl-table-list-select"> 
                                        <a href="/ami/index/users">  <div class="am-btn-group-xs " style="padding-top: 0.2em;"> 
                                    <button class="am-btn am-btn-primary  href="/ami/index/users" /> 清除</button> 
                                    </div>
                                </div></a>   
                                  </div>                                      
                                    
                            <form  method="post" action="/ami/index/users">
                                <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                    <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                        <input name="name" type="text" class="am-form-field"  placeholder="输入用户姓名">
                                        <span class="am-input-group-btn">
                                <input type='submit' class="am-btn  am-btn-default am-btn-success tpl-table-list-field am-icon-search" value="搜索" ></span>
                                    </div>
                                </div>
                            </form>
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="/ami/index/user_details?id=<?php echo htmlentities($vo['id']); ?>">
                                                             详情
                                                        </a>
                                                         <a href="/ami/index/records?id=<?php echo htmlentities($vo['id']); ?>">
                                                             交易记录
                                                        </a>
                                                        <a href="/ami/index/user_user?id=<?php echo htmlentities($vo['id']); ?>" class="tpl-table-black-operation-del">
                                                             删除
                                                        </a>
                                                    </div>
                                                </td>
