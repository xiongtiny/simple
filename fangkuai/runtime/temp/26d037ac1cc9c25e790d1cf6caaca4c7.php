<?php /*a:2:{s:63:"D:\phpStudy\WWW\fangkuai\application\admin\view\farm\index.html";i:1525943057;s:64:"D:\phpStudy\WWW\fangkuai\application\admin\view\public\head.html";i:1526435399;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="/ami/farm/farm_details?id=<?php echo htmlentities($vo['id']); ?>">
                                                             详情
                                                        </a>         
                                                        <a href="/ami/farm/farm_del?id=<?php echo htmlentities($vo['id']); ?>" class="tpl-table-black-operation-del">
                                                             删除
                                                        </a>
                                                    </div>
                                                </td>
