<?php /*a:4:{s:88:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/user/speciallist.html";i:1530604659;s:82:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/header.html";i:1531208860;s:80:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/main.html";i:1531208872;s:79:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/nav.html";i:1530604119;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		<meta charset="utf-8" />
                ...
                <div class="row">
                    ...
                    <div class="page-content">
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                <td class="center"><?php echo htmlentities($special->get_goods->id); ?></td>
                                <td class="center"><?php echo htmlentities($special->get_name->name); ?></td>
                                <td class="center"><?php echo htmlentities($special->get_goods->name); ?></td>
                                <td class="center"><?php echo htmlentities($special->get_goods->flavor); ?></td>
                                <td class="center"><?php echo htmlentities($special->price); ?></td>
                                <td class="center"><a href="/admin/v1/user/editSpecial?id=<?php echo htmlentities($special->id); ?>">修改</a>|
                                    <a href="/admin/v1/user/delSpecial?id=<?php echo htmlentities($special->id); ?>">删除</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            </tbody>
