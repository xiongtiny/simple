		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						<!-- PAGE CONTENT BEGINS -->
						<form class="form-horizontal" role="form" action="/admin/v1/goods/update?id=<?php echo htmlentities($goods->id); ?>" method="post" >
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text"  value="<?php echo htmlentities($goods->whe_price); ?>"  name="price" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">
