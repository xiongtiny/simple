<?php /*a:1:{s:64:"D:\phpStudy\WWW\fangkuai\application\admin\view\login\login.html";i:1525943057;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="am-g tpl-g">
        ...
        <div class="tpl-login">
            <div class="tpl-login-content">
                ...
                <form class="am-form tpl-form-line-form" method="post" action="/ami/login/index">
                    <div class="am-form-group">
                        <input type="text" class="tpl-form-input" name="user" id="user-name" placeholder="请输入账号">
                    </div>
                    <div class="am-form-group">
