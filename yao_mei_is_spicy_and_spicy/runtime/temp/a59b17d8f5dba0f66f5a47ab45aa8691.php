<?php /*a:4:{s:86:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/user/lowerrank.html";i:1530604546;s:82:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/header.html";i:1531208860;s:80:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/main.html";i:1531208872;s:79:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/nav.html";i:1530604119;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		<meta charset="utf-8" />
                ...
                <div class="row">
                    ...
                    <div class="page-content">
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                              <?php foreach($lowerUsers as $lowerUser): ?>
                            <tr>
                                <td align="center"><?php echo htmlentities($lowerUser->name); ?></td>
                                <td align="center"><?php echo htmlentities($lowerUser->phone); ?></td>
                                <td align="center"><?php echo htmlentities($lowerUser->id_card); ?></td>
                                <td align="center">
                                    <?php if($lowerUser->sex == 1): ?>男
                                    <?php elseif($lowerUser->sex == 2): ?>女
                                    <?php else: ?>保密
                                    <?php endif; ?>
                                </td>
                            </tr>
