<?php /*a:1:{s:71:"D:\phpStudy\WWW\fangkuai\application\index\view\v1\user\user_edit1.html";i:1526052941;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
		...
		<div class="container  bottom_6_1">
			...
			<div style="width: 25%;"> <!-- 右侧 -->
				...
				<div style="padding-bottom: 100px;font-size: 16px;">
					<div class="guide_8">
						<a style="text-decoration: none;" href="/index.php/api/v1/user/user_edit1"><div class="guide_8_1 guide_8_1_active">资料与安全</div></a>
					</div>
					<div class="guide_8">
			...
			<div class="user_1">
				<form action="" method="post">
					<div  class="form-group">
						<label  for="">&nbsp;&nbsp;&nbsp;昵称&nbsp;</label>
						<input type="text" id="name" class="form-control_style_user" placeholder="<?php echo htmlentities($name); ?>用户">
					...
					<div class="form-group" >
						<label  for="">支付宝&nbsp;</label>
						<input type="text" id="alipay" class="form-control_style_user" placeholder="请输入支付宝账号">	
					</div>
					<div style="text-align: center;margin-left: -80px;"><button type="submit" onclick="input()" class="user_botton">保存</button></div>
