<?php /*a:4:{s:84:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/goods/lister.html";i:1531291949;s:82:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/header.html";i:1531208860;s:80:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/main.html";i:1531208872;s:79:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/nav.html";i:1530604119;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		<meta charset="utf-8" />
                    ...
                    <div class="page-content">
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th class="center">产品净重(每包/克)</th>
                                <th class="center">零售价(元)</th>
                                <th class="center">批发价格(元)</th>
                                <th class="center">混批价格(元)</th>
                                <th class="center">总代价格(元)</th>
                                <th class="center">产品口味</th>
                            ...
                            <tr>
                                <td align="center"><?php echo htmlentities($good->id); ?></td>
                                <td align="center"><?php echo htmlentities($good->name); ?></td>
                                <td align="center"><img width="50" height="50" src="<?php echo htmlentities($good->img); ?>"/></td>
                                <td align="center"><?php echo htmlentities($good->weight); ?></td>
                                <td align="center"><?php echo htmlentities($good->price); ?></td>
                                <td align="center"><?php echo htmlentities($good->whe_price); ?></td>
                                <td align="center"><?php echo htmlentities($good->batch_price); ?></td>
                                <td align="center"><?php echo htmlentities($good->gen_price); ?></td>
                                <td align="center"><?php echo htmlentities($good->flavor); ?></td>
                                <td align="center" style="color: #428bca">
                                    <a href="/admin/v1/goods/edit/?id=<?php echo htmlentities($good->id); ?>">编辑</a>
                                    |<a href="/admin/v1/goods/lower/?id=<?php echo htmlentities($good->id); ?>">下架</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            </tbody>
                        ...
                        <div>
                            <?php echo $page; ?>
                            <span style="float: right">共 <?php echo htmlentities($count); ?> 个商品</span>
                        </div>
