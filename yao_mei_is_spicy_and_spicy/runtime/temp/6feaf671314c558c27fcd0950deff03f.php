                    ...
                    <div class="page-content">
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td align="center"><a href="/admin/v1/goods/edit/?id=<?php echo htmlentities($good->id); ?>">编辑</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            </tbody>
