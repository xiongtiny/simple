<?php /*a:4:{s:82:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/goods/edit.html";i:1530604383;s:82:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/header.html";i:1531208860;s:80:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/main.html";i:1531208872;s:79:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/nav.html";i:1530604119;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		<meta charset="utf-8" />
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						<!-- PAGE CONTENT BEGINS -->
						<form class="form-horizontal" role="form" action="/admin/v1/goods/update?id=<?php echo htmlentities($goods->id); ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">产品名称: </label>
								<div class="col-sm-9">
									<input type="text" id="form-field" value="<?php echo htmlentities($goods->name); ?>"  name="name" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">
                                ...
                                <div class="col-sm-9" style="margin-top: 5px; float: left;">
                                    <div  style="height:120px;width: 120px; border:1px solid #dd514c; text-align: center">
                                        <div id="preview3" style="">
                                            <!-- <img id="imghead3" border="0" src="/static/assets/upload_img/upload-img.png" width="50px"  onclick="$('#previewImg3').click();" style="padding-top: 30px;"> -->
			              					<img id="imghead3" border="0" src="<?php echo htmlentities($goods->img); ?>" style="width: 118px; height: 118px;" onclick="$('#previewImg3').click();">
                                        </div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">产品净重(克): </label>

								<div class="col-sm-9">
									<input type="text" value="<?php echo htmlentities($goods->weight); ?>"  name="weight" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">零售价(元): </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" value="<?php echo htmlentities($goods->price); ?>"  name="price" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">批发价格(元): </label>

								<div class="col-sm-9">
									<input type="text"  value="<?php echo htmlentities($goods->whe_price); ?>"  name="whe_price" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">混批价格(元): </label>

								<div class="col-sm-9">
									<input type="text"  value="<?php echo htmlentities($goods->batch_price); ?>"  name="batch_price" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">总代价格(元): </label>
								<div class="col-sm-9">
									<input type="text" value="<?php echo htmlentities($goods->gen_price); ?>"  name="gen_price" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">产品口味: </label>
								<div class="col-sm-9">
									<select class="form-control" name="flavor" style="width: 150px;">
										<option value="中辣"><?php echo htmlentities($goods->flavor); ?></option>
