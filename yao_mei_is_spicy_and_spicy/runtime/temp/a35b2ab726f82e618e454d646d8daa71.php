<?php /*a:4:{s:82:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/admin/edit.html";i:1530604765;s:82:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/header.html";i:1528967454;s:80:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/main.html";i:1528967454;s:79:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/nav.html";i:1530604119;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		<meta charset="utf-8" />
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						<!-- PAGE CONTENT BEGINS -->
						<form class="form-horizontal" role="form" action="/admin/v1/admin/update?id=<?php echo htmlentities($admin->id); ?>" method="post" >
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">用户名: </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" value="<?php echo htmlentities($admin->username); ?>"  name="name" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码: </label>
								<div class="col-sm-9">
									<input type="text" id="form-field-3" value=""  name="pwd" class="col-xs-10 col-sm-5" />
								</div>
								<div class="col-sm-9">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">再次确认密码</label>
								<div class="col-sm-9">
									<input type="text" id="form-field-4" value=""  name="repwd" class="col-xs-10 col-sm-5" />
								</div>
								<div class="col-sm-9">
								</div>
							</div>
