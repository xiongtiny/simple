<?php /*a:4:{s:89:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/order/updateorder.html";i:1530777652;s:82:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/header.html";i:1530605297;s:80:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/main.html";i:1528967454;s:79:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/nav.html";i:1530604119;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		<meta charset="utf-8" />
                        ...
                        <form class="form-horizontal" role="form" action="" method="post" >
                            <table border="2px" id="table">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="width: 20px;">商品数量</td>
                                    <td >操作</td>
                                </tr>
                                 <?php foreach($goods as $good): ?>
                                <tr>
                                    <td colspan="2">
                                       <?php echo htmlentities($good->get_name->name); ?>
                                        </td>
                                    <td colspan="2">
                                   <input type="number" name="sum" placeholder="<?php echo htmlentities($good->sum); ?>"/>
                                        </td>
                                     <td>
                                         <a href="/admin/v1/order/del?goods_id=<?php echo htmlentities($good->goods_id); ?>">删除</a>
                                     </td>
                                </tr>
                                <?php endforeach; ?>
                                 <!--<div style="position: relative; width:80px;height: 30px; left:280px; top: 260px;border: 1px solid black;" >-->
                                     <!--添加商品-->
                                 <!--</div>-->
                                   <button style="position: relative; width:80px;height: 30px; left:300px; top: 260px;"  onclick="add()">
                                       添加商品
                                   </button>
                            </table>
                        </form>
            ...
            <script type="text/javascript">
                    ...
                    function add() {
                       ...
                       NewRow = Table.insertRow();                        //添加行
                        ...
                        NewCell1.innerHTML = "<td>123</td>";          //添加数据
                        NewCell1.innerHTML="<td>123</td>";
                    }
            </script>
</body>
</html>
