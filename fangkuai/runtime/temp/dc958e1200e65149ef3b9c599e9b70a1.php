<?php /*a:1:{s:74:"D:\phpStudy\WWW\fangkuai\application\index\view\v1\user\user_release1.html";i:1526139348;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
		...
		<div class="container  bottom_6_1">
			...
			<div style="width: 25%;"> <!-- 右侧 -->
				...
				<div style="padding-bottom: 100px;font-size: 16px;">
					...
					<div class="guide_8">
						<a style="text-decoration: none;" href="/index.php/api/v1/user/user_release1"><div class="guide_8_1 guide_8_1_active">我发布的农场</div></a>
					</div>
					<div class="guide_8">
			...
			<div class="user_2"><!-- 左侧 -->
				<button class="user_button_1" onclick="window.open('/index.php/api/v1/farm/add_farm1')"> <span  class="icon-j1"></span>&nbsp;发布农场</button>
				<div class="bottom_6_1">
						
						<div class="my_farm"> <!-- 修改and删除 -->
							...
							<div class="my_farm_text  small-font smallsize-font">
								...
								<div class="my_farm_text">
									<span class="my_publish_money"><span class="my_publish_money_1">6200</span>元/年</span>
									<a style="text-decoration: none;" href="/index.php/api/v1/farm/edit_farm1" class="my_publish_action">修改</a>
									<a style="text-decoration: none;" href="/index.php/api/v1/user/del_farm" class="my_publish_action_1">删除</a>
								</div>
									
							

						</div>
						<div class="my_farm"><!-- 已租出 -->
						<a style="text-decoration: none;" href="/index.php/api/v1/farm/farm_detail1">
							<img src="/static/image/picture_1.png" alt="">
							<div class="my_farm_text  small-font smallsize-font">
								武汉汉南农场一区<br>
								<span class="my_publish">
										租出时间：2018-03-15至2019-05-15
								</span><br>
