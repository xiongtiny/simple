				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<form action="" id="form1" method="post">
							<div style="position:absolute;top:45px;right:700px; height: 200px; width: 200px;" > <span  >状态：</span>
								<select id="status" name="status">
									<option  value="2">待审状态</option>
							...
							<form action=""  method="post">
								<div style="position:absolute ;left: 200px; top: 45px;" > <span  >时间：</span>
												...
												<tbody>
                                                 <?php foreach($orders as $order): ?>
													<tr>
														...
														<td class="center">
															<?php if($order->log_type == 1): ?>顺丰空运
															<?php elseif($order->log_type == 2): ?>顺丰陆运
															 <?php else: ?>普通物流
															 <?php endif; ?>
															</td>
														...
														<!--<td class="center">-->
                             <!--<?php echo htmlentities($order->get_pro->name); ?>-<?php echo htmlentities($order->get_city->name); ?>-<?php echo htmlentities($order->get_area->name); ?>-<?php echo htmlentities($order->address_deta); ?>-->
														<!--</td>-->
														<td class="center">
															<?php if($order->status ==2): ?>待审状态
															<?php elseif($order->status ==3): ?>已审核
															<?php elseif($order->status ==4): ?>已驳回
															 <?php else: endif; ?>
															</td>
														<td class="center">
