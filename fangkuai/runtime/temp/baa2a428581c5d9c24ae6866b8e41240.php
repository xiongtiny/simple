<?php /*a:3:{s:67:"D:\phpStudy\WWW\fangkuai\application\index\view\v1\index\index.html";i:1526441317;s:67:"D:\phpStudy\WWW\fangkuai\application\index\view\v1\public\head.html";i:1526437494;s:67:"D:\phpStudy\WWW\fangkuai\application\index\view\v1\public\foot.html";i:1526435605;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	...
	<div class="container picture"><!-- 农场直播 -->
		<div class="bottom_6_1">
			...
			<div class="container_2"><br><br>
				<a href="/api/v1/farm/index">More <img src="/static/image/ico_5.png"	></a>
			</div>
		</div>
		<div>
			<div class="show_farm">
					...
					<div class="show_farm">
						...
						<div class="show_farm_1"><!-- 第一个农场 -->
							<a style="text-decoration: none;" href="/index.php/api/v1/farm/farm_detail?farm_id=<?php echo htmlentities($vo['id']); ?>">

								<img src="/static/image/picture_1.png" alt="">
								<div class="show_farm_text">
									<div class="show_farm_name"><span><?php echo htmlentities($vo['name']); ?></span></div>
									<div  class="bottom_6_1 show_farm_map">
										<div class="show_farm_map_left"><img src="/static/image/ico_9.png" alt=""></div>
										<div class="show_farm_map_right"><?php echo htmlentities($vo['province']); ?><?php echo htmlentities($vo['city']); ?><?php echo htmlentities($vo['address']); ?></div>
									</div>
									<div class="bottom_6_1 show_farm_money">
										...
										<div class="show_farm_money_right" style="margin-left: 0px;"><span style="font-size: 23px;color:#e00000; "><?php echo htmlentities($vo['price']); ?></span>元/
											<?php switch($vo['lease_type']): case "1": ?>年<?php break; case "2": ?>半年<?php break; case "3": ?>季<?php break; case "4": ?>月<?php break; default: endswitch; ?>
										</div>
									</div>
								</div>
							</a>
