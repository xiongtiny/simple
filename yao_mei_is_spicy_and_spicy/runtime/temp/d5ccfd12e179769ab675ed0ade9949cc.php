<?php /*a:4:{s:85:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/user/userlist.html";i:1531386207;s:82:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/header.html";i:1531208860;s:80:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/main.html";i:1531208872;s:79:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/nav.html";i:1530604119;}*/ ?>
            ...
            <div class="page-content">
                <div class="row" style="margin:0px;">
                        <form action="" method="post">
                            <div style="padding-left: 20px;padding-bottom: 10px;">用户名称:
                                <input type="text" name="name" placeholder="请输入用户姓名">
                                <button type="submit">搜索</button>
                            </div>
                        </form>
                    <form action="/admin/v1/user/excel" method="post">
                        <div style="position: relative;top:-51px;left: 300px;">
                            导出:
                    ...
                    <div style="position:relative; top: -50px; left: -10px">
                      ...
                      <?php foreach($users as $user): ?>
                            <tr>
                                ...
                                <td align="center">
                                    <?php if($user->grade ==1): ?>一级代理
                                    <!--<a href="/admin/v1/user/upgrade?id=<?php echo htmlentities($user->id); ?>">升级总代</a>-->
                                    <!-- <a href="/admin/v1/user/upgrade?id=<?php echo htmlentities($user->id); ?>" onclick="return confirm('确定升级？')">升为总代</a>|<a href="/admin/v1/user/cancel?id=<?php echo htmlentities($user->id); ?>">取消推荐代理</a> -->
                                    <?php else: ?>
                                        总代
                                    <?php endif; ?>
                                    </td>
                                <td align="center">
                                     <?php if($user->status == 1): ?><span style="color: green">已通过</span>
                                      <?php elseif($user->status == 2): ?><span style="color: red">未通过</span>
                                       <?php else: ?><span style="color: #1E90FF">待审核</span>
                                      <?php endif; ?>
                                </td>
                                <td align="center">
                        ...
                        <div>
                            <?php echo $page; ?>
                            <span style="float: right">共 <?php echo htmlentities($count); ?> 个用户</span>
                        </div>
                    </div>
                    </div><!--page-content-->
...
<script type="text/javascript" src="/static/assets/layer/modules/jquery.js"></script>
<script src="/static/assets/layer/modules/layer.js"></script>
     <script type="text/javascript">
         function upgrade() {
             //在这里面输入任何合法的js语句
             layer.open({
