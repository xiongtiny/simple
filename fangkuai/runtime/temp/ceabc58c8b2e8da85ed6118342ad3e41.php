<?php /*a:1:{s:80:"D:\phpStudy\WWW\fangkuai\application\index\view\v1\index\retrieve_password1.html";i:1526291144;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	...
	<div class="bottom_6 ">
		...
		<div class="bottom_9 bottom_6_1">
			...
			<div class="bottom_9_2 bottom_9_3">
				<span style="font-size: 30px;">忘记密码</span><br><br>
				...
				<form action="">
						...
						<div class="form-group user_input"><!--  验证码输入框 -->
							<input type="text" id="code" class="form-control_style_login" placeholder="验证码">
						...
						<div class="form-group user_input"> <!-- 新密码输入框 -->
						<input type="text" id="password" class="form-control_style_login" placeholder="新密码"><img class="user_ico" src="/static/image/user_2.png" alt="">
					
						</div>
						<br>
						<div class="form-group"><button class="bottom_9_4" type="button" onclick="input()">确认</button></div>	
				</form>
			</div>
		</div>
		</div>
...
<script>
	...
	function input() {
	  $.ajax({ 
		    type: "post", 	
			url: "/index.php/api/v1/index/retrieve_password",
			data: {
				phone: $("#phone").val(), 
