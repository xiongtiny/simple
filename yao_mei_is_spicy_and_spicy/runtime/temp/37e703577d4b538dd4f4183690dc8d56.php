<?php /*a:4:{s:81:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/admin/add.html";i:1530604792;s:82:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/header.html";i:1531208860;s:80:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/main.html";i:1531208872;s:79:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/nav.html";i:1530604119;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		<meta charset="utf-8" />
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form class="form-horizontal" role="form" action="<?php echo url('/admin/v1/admin/save'); ?>" method="post">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="subject">用户名： </label>

								<div class="col-sm-9">
									<input type="text" id="subject" name="name" placeholder="请输入用户名" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right">密&nbsp;&nbsp;&nbsp;&nbsp;码：</label>

								<div class="col-sm-9">
									<input type="text"  name="pwd" placeholder="请输入密码" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right">密&nbsp;&nbsp;&nbsp;&nbsp;码：</label>
								...
								<div class="col-sm-9">
									<input type="text"  name="repwd" placeholder="请再次输入密码" class="col-xs-10 col-sm-5" />
								</div>
							</div>
