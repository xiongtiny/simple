<?php /*a:4:{s:88:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/user/editspecial.html";i:1528967454;s:82:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/header.html";i:1531208860;s:80:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/main.html";i:1531208872;s:79:"/home/wwwroot/yao_mei_is_spicy_and_spicy/application/admin/view/v1/Inc/nav.html";i:1530604119;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		<meta charset="utf-8" />
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form class="form-horizontal" role="form" action="/admin/v1/user/saveSpecial?id=<?php echo htmlentities($specials->id); ?>" method="post" >
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">商品名称: </label>

                                        <div class="col-sm-9">
                                            <input type="text" id="form-field" value="<?php echo htmlentities($specials->get_goods->name); ?>"  name="name" class="col-xs-10 col-sm-5" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">商品特价(元): </label>

                                        <div class="col-sm-9">
                                            <input type="text" value="<?php echo htmlentities($specials->price); ?>"  name="price" class="col-xs-10 col-sm-5" />
                                        </div>
                                    </div>
