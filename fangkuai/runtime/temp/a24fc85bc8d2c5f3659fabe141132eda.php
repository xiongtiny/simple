<?php /*a:3:{s:70:"D:\phpStudy\WWW\fangkuai\application\index\view\v1\farm\edit_farm.html";i:1526458489;s:67:"D:\phpStudy\WWW\fangkuai\application\index\view\v1\public\head.html";i:1526437494;s:67:"D:\phpStudy\WWW\fangkuai\application\index\view\v1\public\foot.html";i:1526435605;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="bottom_6">
	<form action=""  id="form" enctype="multipart/form-data">
		...
		<div class="container bottom_6_rim">修改农场<br><br>
			<div class="bottom_6_color bottom_6_1">
				<div><!-- 左侧表单 -->
					...
					<div class="form-group">
						...
						<input type="text" name="name" id="name" class="form-control_style" value="<?php echo htmlentities($data['name']); ?>">


					</div>
					<div class="form-group">
						<label for="">所在地区&nbsp;</label>
						<button type="button" id="origin"  class="form-control_style" style="text-align: left" ><?php echo htmlentities($data['province']); ?>&nbsp;&nbsp;<?php echo htmlentities($data['city']); ?>&nbsp;&nbsp;<?php echo htmlentities($data['area']); ?></button>
					...
					<div class="form-group">
						...
						<input id="address" name="address" type="text" class="form-control_style" value="<?php echo htmlentities($data['address']); ?>"><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<span class="prompt">在右侧地图标注详细位置</span>

					</div>
					<div  class="form-group">
						<label  for="">联系电话&nbsp;</label>
						<input id="phone" name="phone" type="text" class="form-control_style" value="<?php echo htmlentities($data['phone']); ?>" >

					</div>
					<div class="form-group">
						<label  for="">设备编号&nbsp;</label>
						<input id="number" name="equipment_number" type="text" class="form-control_style" value="<?php echo htmlentities($data['equipment_number']); ?>">

					</div>
					<div class="form-group" >
						<label  for="">农场面积&nbsp;</label>
						<input id="area" name="acreage" type="text" class="form-control_style_4" value="<?php echo htmlentities($data['acreage']); ?>">&nbsp;m²

					</div>
					<div class="form-group" >
						<label  for="">价格设定&nbsp;</label>
						<input id="price" name="price" type="text" class="form-control_style" value="<?php echo htmlentities($data['price']); ?>" style="width: 58%;">
						&nbsp;元&nbsp;/&nbsp;
					...
					<div  class="form-group">
						...
						<input <?php if(in_array($vo1['name'],$data['service'],true)): ?> checked <?php endif; ?> name="service[]" id="service" type="checkbox" value="<?php echo htmlentities($vo1['id']); ?>">
						<label for="">&nbsp;<?php echo htmlentities($vo1['name']); ?>&nbsp;</label>
					...
					<div class="form-group bottom_6_1">
						...
						<div><textarea name="describe" id="" cols="30" rows="10" class="form-control_style_1" placeholder="场地长宽、周围气候风貌、人情风俗、适合的作物种类"><?php echo htmlentities($data['describe']); ?></textarea></div>
					...
					<div class="avatar">
						...
						<div class="form-group">
							...
							<div class="fileinput-new thumbnail" style="width: 300px;height:150px;">
								<img style="max-width: 100%;max-height: 100%;" src="<?php echo htmlentities($data['img']); ?>" id="img-change" />
							</div>
