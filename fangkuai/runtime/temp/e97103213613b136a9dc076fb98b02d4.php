<?php /*a:1:{s:70:"D:\phpStudy\WWW\fangkuai\application\index\view\v1\user\feedback1.html";i:1526139305;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
		...
		<div class="container  bottom_6_1">
			...
			<div style="width: 25%;"> <!-- 右侧 -->
				...
				<div style="padding-bottom: 100px;font-size: 16px;">
					...
					<div class="guide_8">
						<a style="text-decoration: none;" href="/index.php/api/v1/user/feedback1"><div class="guide_8_1 guide_8_1_active">意见反馈</div></a>
					</div>
				</div>
			</div>
			...
			<div class="user_1_1">
				...
				<div  class="form-group">
					...
					<input type="text" id="phone" class="form-control_style_2" placeholder="我们将及时与你沟通">
