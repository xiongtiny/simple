<?php /*a:4:{s:96:"D:\phpStudy\PHPTutorial\WWW\yao_mei_is_spicy_and_spicy\application\admin\view\v1\admin\oper.html";i:1528885822;s:96:"D:\phpStudy\PHPTutorial\WWW\yao_mei_is_spicy_and_spicy\application\admin\view\v1\Inc\header.html";i:1528883234;s:93:"D:\phpStudy\PHPTutorial\WWW\yao_mei_is_spicy_and_spicy\application\admin\view\v1\Inc\css.html";i:1528885717;s:93:"D:\phpStudy\PHPTutorial\WWW\yao_mei_is_spicy_and_spicy\application\admin\view\v1\Inc\nav.html";i:1528887587;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
	...
	<body>
		<div class="navbar navbar-default" id="navbar" style="background :lightskyblue; height: 5%;margin-top: -19px">
	...
	<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														<td align="center"><?php echo htmlentities($oper['id']); ?></td>
														<td align="center"><?php echo htmlentities($oper['username']); ?></td>
														<td align="center"><?php echo htmlentities($oper['create_time']); ?></td>
														<!--<td align="center">-->
															<!--<a href="<?php echo url('/admin/v1/oper/edit/'.$oper->id); ?>">编辑</a>&nbsp;|&nbsp;-->
															<!--<a href="<?php echo url('/admin/v1/oper/del/'.$oper->id); ?>">删除</a>-->
														<!--</td>-->
														<td align="center"><a href="/admin/v1/admin/edit?id=<?php echo htmlentities($oper->id); ?>">修改</a>|
															<a href="/admin/v1/admin/del?id=<?php echo htmlentities($oper->id); ?>">删除</a>
																</td>
													</tr>
													<?php endforeach; ?>
												</tbody>
